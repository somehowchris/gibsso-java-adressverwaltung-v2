...
import adressverwaltung.Adressverwaltung;
...
public class AdressVerwaltungTest {
         ...
         */
        /*
         * @Test public void testInputJTex() throws InterruptedException {
         * 
         * String testString = "testing";
         * 
         * // instantiated?
         * 
         * JTextField kontonummer = (JTextField)TestUtils.getChildNamed(this.kv,
         * "kontonummer"); JTextField name =
         * (JTextField)TestUtils.getChildNamed(this.kv, "nachname"); JTextField vorname
         * = (JTextField)TestUtils.getChildNamed(this.kv, "vorname");
         * 
         * JTextField betrag = (JTextField)TestUtils.getChildNamed(this.kv, "betrag");
         * 
         * assertNotNull(kontonummer); kontonummer.setText(testString);
         * kontonummer.postActionEvent(); // type in a test message + ENTER
         * assertEquals(testString, kontonummer.getText());
         * 
         * assertNotNull(name); name.setText(testString); name.postActionEvent(); //
         * type in a test message + ENTER assertEquals(testString, name.getText());
         * 
         * assertNotNull(vorname); vorname.setText(testString);
         * vorname.postActionEvent(); // type in a test message + ENTER
         * assertEquals(testString, vorname.getText());
         * 
         * assertNotNull(betrag); betrag.setText(testString); betrag.postActionEvent();
         * // type in a test message + ENTER assertEquals(testString, betrag.getText());
         * 
         * 
         * sleep(3000);
         * 
        ...
        public void testOeffnen() throws InterruptedException {
                ...
                String result = "jumper";
                sleep(1500);
                assertNotNull(oeffnen);
                assertNotNull(kontonummer);

                kontonummer.setText("1");
                kontonummer.postActionEvent(); // type in a test message + ENTER
                assertEquals("1", kontonummer.getText());
